    ...
    <div className="grid max-h-[780px] grid-cols-9 grid-rows-6 gap-6">
      ...
      {otherProducts.map((product) => (
        ...
        >
          ...
          <div className="absolute md:right-3 bottom-10 right-28 h-12 flex items-center gap-2 max-w-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
